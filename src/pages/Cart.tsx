...
import { FormControl, TextField, Grid, FormControlLabel, Checkbox} from '@mui/material';
        ...
        <div className="cart-page-content">
            ...
            <div className="list-products">
                ...
                <FormControl fullWidth sx={{margin: '1rem 0'}}>
                    ...
                    <FormControlLabel control={<Checkbox />} label="Đăng ký nhận email" style={{fontWeight: 'bold'}}/>
                    <FormControlLabel control={<Checkbox />} label="Create an account" />

                    <p style={{fontWeight: 'bold', marginBottom: '1rem', marginTop: '1rem'}}>ADDITIONAL INFORMATION</p>
                    <label htmlFor="order-notes" style={{fontWeight: 'bold'}}>Order notes (optional)</label>
                    <TextField id="order-notes" variant="outlined" fullWidth placeholder='Ghi chú về đơn hàng, ví dụ: thời gian hay chỉ dẫn địa điểm giao hàng'
                    sx={{ 
                        height: 150, 
                    ...
                    <div className='cart-page-summary'>
                        ...
                        <div className='form-content'>
                            <p>Nhân viên sẽ  liên hệ để thông báo thời gian giao hàng. Phí giao hàng sẽ được thông báo qua điện thoại </p>
                        </div>
                        <div className='form-content'>
                        ...
                        <div style={{marginBottom: '2rem'}}>
                            ...
                            <p>Thông tin chuyển khoản sẽ hiển thị sau khi bạn đặt hoàn tất đơn hàng. Vui lòng ghi mã đơn hàng của bạn trong phần Nội dung thanh toán. Đơn hàng sẽ được giao sau khi tiền đã chuyển.</p>
                        </div>
                        <button style={{backgroundColor: '#357CFF', borderColor: 'transparent', width: '90%', marginLeft: '5rem'}} className='button-order'>
                            <div style={{paddingBottom: '1rem', paddingTop: '1rem'}}>
                                <p>PLACE ORDER</p>
                                <p>Hoàn tiền với sản phẩm pate hỗn hợp gà: nếu sau 3 ngày boss không ăn,</p>
